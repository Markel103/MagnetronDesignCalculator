...
Add a license file before publishing the repository (e.g., MIT, BSD-3, GPL-3.0, etc.).

---

If you plan to publish this repository publicly: double-check that any PDFs or OCR artifacts in the folder are distributable under the rights you have (some references may be copyrighted).
